    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function submitLunch() {
                ...
                if (noOfSabzi == 3) {
                    if (sabzi1 == sabzi2 || sabzi1 == sabzi3 || sabzi2 == sabzi3) {
                        flag = false;
                    }
                }
                if (noOfSabzi == 4) {
                    if (sabzi1 == sabzi2 || sabzi1 == sabzi3 || sabzi1 == sabzi4 || sabzi2 == sabzi3 || sabzi2 == sabzi4 || sabzi3 == sabzi4) {
                        flag = false;
                    }
                }
                if (flag == true) {
                ...
                <div class="row-fluid">
                    <div class="lunchBox" style="float:left;width:49%;">
                        <div class="w-box">
                            ...
                            <div class="w-box-content">
                                <c:choose>
                                    <c:when test="${listLunch.getMenuID() == 0}">
                                    ...
                                    <c:otherwise>
                                        <div style="padding:10px;">
                                            <span class="alert">You have already updated lunch. To cancel lunch <a href="AdminController?action=deleteMenu&menuID=${listLunch.getMenuID()}" class="btn">Click here</a></span>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                    ...
                    <div class="dinnerBox" style="float:right;width:49%;">
                        <div class="w-box">
                            ...
                            <div class="w-box-content">
                                <c:choose>
                                    <c:when test="${listDinner.getMenuID() == 0}">
                                    ...
                                    <c:otherwise>
                                        <div style="padding:10px;">
                                            <span class="alert">You have already updated dinner. To cancel dinner &nbsp; <a href="AdminController?action=deleteMenu&menuID=${listDinner.getMenuID()}" class="btn">Click here</a></span>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
                            </div>
