...
<link rel="stylesheet" href="../admin/img/icsw2_16/icsw2_16.css">
<!-- splashy icon pack -->
<link rel="stylesheet" href="../admin/img/splashy/splashy.css">
<!-- flag icons -->
<link rel="stylesheet" href="../admin/img/flags/flags.css">
<!-- power tooltips -->
<link rel="stylesheet" href="../admin/js/lib/powertip/jquery.powertip.css">
<!-- google web fonts -->
...
<!-- colorbox -->
<link rel="stylesheet" href="../admin/js/lib/colorbox/colorbox.css">
<!--fullcalendar -->
<link rel="stylesheet" href="../admin/js/lib/fullcalendar/fullcalendar_beoro.css">
