    ...
    beoro_boxes = {
        show_hide: function() {
            ...
            $('.w-box-header .icon-plus,.w-box-header .icon-minus').click(function() {
                var this_box_content = $(this).toggleClass('icon-plus icon-minus').closest('.w-box').find('.w-box-content'),
                    box_height = this_box_content.actual('height');
                this_box_content.css({
                    'height': box_height,
                    'maxHeight': box_height
                }).slideToggle(400, function() { this_box_content.css({'height':'','maxHeight':''}) });
            });
        }
    };
