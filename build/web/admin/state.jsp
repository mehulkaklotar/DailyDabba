<%-- 
    Document   : state
    Created on : 14 Oct, 2013, 11:30:43 PM
    Author     : Kiran
--%>
    ...
    <!-- main wrapper (without footer) -->    
        ...
        <div class="container">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="javascript:void(0)">View State</a></li>
                        ...
                        <div class="w-box">
                            ...
                            <div class="w-box-content">
                                <table class="table table-vam table-striped" id="dt_gal">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type="checkbox" name="cbState" class="row_sel" /></td>
