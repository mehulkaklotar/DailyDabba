        ...
        <body class="bg_d">
            ...
            <jsp:include page="header.jsp"></jsp:include>
                ...
                <div class="container">
                    <div class="row-fluid">
                        <div class="span12">
                            <form class="form-horizontal" action="AdminController?action=BlockCustomer&vendorUN=Sai" method="post">
                              
                                <fieldset>
                                    <legend>Block Customers:</legend>
                                    <div class="control-group">
                                        
                                        <label class="control-label" for="lblCustomerName">Customer name:</label>
                                        <div class="controls">
                                            <select id="customerList" name="customerList">
                                                <option>-Select-</option>
                                                 <c:forEach items="${Customers}" var="customer">
                                                     <option value="${customer.userName}">${customer.firstName}</option>
                                                 </c:forEach>
                                            </select>
                                        </div>
