            ...
            <jsp:include page="header.jsp"></jsp:include>
                ...
                <div class="container">
                    <ul id="breadcrumbs">
                        ...
                        <li><a href="AdminController?action=createUpdateMenuPage">Upload menu</a></li>
                        <li><span>Uploaded menu...</span></li>
                    </ul>
                </div>
                            ...
                            <div class="w-box">
                                ...
                                <div class="w-box-content" style="padding:10px;">
                                    <table class="table table-vam table-striped" id="dt_gal">
                                        ...
                                        <tbody>
                                        <c:forEach items="${Items}" var="mitem">
                                            <tr>
                                                <td>${mitem.item.itemName}</td>
                                                <td>${mitem.item.type.typeName}</td>
                                                <td>${mitem.cost}</td>
