<%-- 
    ...
    Created on : Oct 30, 2013, 4:22:48 AM
    Author     : AKYP
--%>
...
<html lang="en-US">
    <head>
        ...
        <meta charset="UTF-8">
        <title>Daily Dibba: Vendor Panel</title>
            ...
            <jsp:include page="header.jsp"></jsp:include>
                ...
                <div class="container">
                    <ul id="breadcrumbs">
                        ...
                        <li><a href="javascript:void(0)">Add Item Type...</a></li>
