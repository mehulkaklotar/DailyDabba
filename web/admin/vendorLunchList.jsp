            ...
            <jsp:include page="header.jsp"></jsp:include>
                ...
                <div class="container">
                    <ul id="breadcrumbs">
                        ...
                        <li><a href="javascript:void(0)">View Lunch Order</a></li>
                                ...
                                <div class="w-box-content" style="padding: 10px;">
                                    <table class="table table-vam table-striped" id="dt_gal">
                                        ...
                                        <c:forEach items="${lunch}" var="menu">
                                            <tr title="Click on Order ID to see the full Order Detail">
                                                <!--<td><input type="checkbox" name="row_sel" class="row_sel" /></td>-->
                                                <td><a href="AdminController?action=getVendorLunchOrder&id=${menu.OrderID}&name=${menu.Vendor}">${menu.OrderID}</a></td>
                                                <td>${menu.NoOfTiffin}</td>
                                                <td>${menu.Customer}</td>
                                                <td>${menu.DeliveryAddress}</td>
                                                <td>${menu.Total}</td>
                                            </tr>
                                        </c:forEach>
                                        <!--<div class="btn-group">
